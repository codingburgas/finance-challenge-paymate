...
void signup()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawText("Sign up from here!", GetScreenWidth() / 2 + 30, GetScreenHeight() / 2 - 15, 50, BLACK);
        DrawText("!Note: the password must contain at least one\n   uppercase, lowercase, number and symbol", GetScreenWidth() / 2 + 190, GetScreenHeight() / 2 - 250, 30, BLACK);
        DrawText("Username:", GetScreenWidth() / 2 + 25, GetScreenHeight() / 2 - 50, 50, BLACK);
        DrawText("Password:", GetScreenWidth() / 2 + 25, GetScreenHeight() / 2, 5, BLACK);
        ...
        DrawRectangleRec(signupButton, (CheckCollisionPointRec(mousePosition, signupButton) ? BLACK : BLACK));
...
void startingScreen()
{
    ...
    Vector2 loginButtonPosition = { 250, 540 };
    Vector2 signUpButtonPosition = { 450, 740 };
    Vector2 exitButtonPosition = { 450,  840 };
